...
async function updateUserRequest( request, response, next ) {
    try {
        const parameters = request.params
        const body = request.body
        await userSchemas.updateUserBodySchema.validate( body )
        await userSchemas.updateUserParameterSchema.validate( parameters )
        next()
